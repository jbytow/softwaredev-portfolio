              ...
              <div className="flex gap-3 mt-4">
                ...
                {post.liveUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-dark-800 hover:bg-dark-700 border border-dark-600 rounded-lg text-dark-200 hover:text-accent transition-colors text-sm"
                  >
          ...
          {post.hasCaseStudy && (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-4 bg-gradient-to-r from-primary-500/10 to-accent/10 border border-primary-500/20 rounded-xl hover:border-primary-500/40 transition-colors"
              >
                  ...
                  >
                    <div className="pt-6 space-y-6">
                      ...
                      {post.caseStudyTestimonial && (
                        <div className="card bg-gradient-to-br from-primary-500/5 to-accent/5 border border-primary-500/20">
                          <div className="flex items-start gap-4">
